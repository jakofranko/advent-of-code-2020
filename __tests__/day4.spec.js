...
const passportData = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
describe('Day 4', ()=> {
    it('Part 1', () => {
        expect(passportValidator(passportData)).toBe(2);
    });
    ...
    it('Part 2', () => {
        ...
        expect(rules['hcl']('#123abcz')).toBe(false);
        ...
        expect(passportValidator(invalidPassports, true)).toBe(0);
        expect(passportValidator(validPassports, true)).toBe(4);
    });
});
